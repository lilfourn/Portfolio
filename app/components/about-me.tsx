  ...
  const aboutCards = [
    {
      ...
      description: "Building modern web applications with a focus on clean code and exceptional user experiences.",
    ...
    },
    {
      ...
      description: "Aspiring to build innovative software solutions and lead a tech company that makes a difference.",
    ...
    },
    {
      ...
      description: "Finding inspiration in outdoor adventures and quality time with my dog, Roux.",
        ...
        <div className="grid md:grid-cols-3 gap-8 relative mt-8">
          {aboutCards.map((card, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br ${card.gradient} p-px ${
                index === 1 ? 'md:-mt-12' : ''
              }`}
            >
              <div className="relative h-full rounded-2xl bg-zinc-900/90 p-8 transition-all duration-300 group-hover:bg-zinc-900/70 backdrop-blur-sm">
                ...
                <div className="space-y-2">
                  <p className="text-sm font-medium text-zinc-400">{card.subtitle}</p>
          ...
          <Link href="/hire" className="group inline-flex items-center gap-2">
            <div className="relative">
              ...
              <div className="relative inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-800/50 text-zinc-400 ring-1 ring-white/10 group-hover:bg-zinc-800/70 group-hover:ring-white/20 transition-all duration-300">
                ...
                <span className="text-sm group-hover:text-white transition-colors duration-300">Always up for a coffee chat about tech and design</span>
              </div>
            </div>
          </Link>
        </motion.div>
